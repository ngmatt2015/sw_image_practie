...
void medianFiltering_opencvCommand(int kernelsize, void *userData);
...
int main(int argc, char *argv[])
{
	if (argc != 2) {
		cout << "[프로그램 사용법]" << endl;
		cout << "명령문 : swLab19f.exe lena_24.bmp" << endl;
		return 0;
	}
	...
	createTrackbar("KernelValue", window_name, &start_value, max_value, medianFiltering_opencvCommand, static_cast<void*>(&window_name));
